...
export default function Hero({
  ...
  // Title classes
  const titleClasses = `font-[family-name:var(--font-averia)] font-bold leading-tight break-words ${
    isFullscreen
  ...
  // Subtitle classes
  const subtitleClasses = `font-[family-name:var(--font-averia)] font-light leading-tight break-words ${
    isFullscreen
