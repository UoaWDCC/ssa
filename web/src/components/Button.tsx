...
const treatments: Record<ButtonVariant, Record<ButtonColor, string>> = {
  filled: {
    ...
    salmon: 'bg-ssa-salmon text-ssa-white hover:bg-ssa-yellow-light hover:text-ssa-salmon',
  },
  light: {
    ...
    salmon: 'bg-ssa-yellow-light text-ssa-salmon hover:bg-ssa-salmon hover:text-ssa-white',
  },
  outline: {
    ...
    salmon: 'bg-transparent border-[3px] border-ssa-salmon text-ssa-salmon hover:bg-ssa-salmon hover:text-ssa-white',
  },
}
