      ...
      <div className="mx-auto w-full max-w-[1244px]">
        ...
        {filteredEvents.length > 0 && (
          <div className="mt-14 text-center">
            <p className="font-inter text-base font-normal tracking-[-0.4px] text-grey">
            ...
            {hasMore && (
              <button
                ...
                className="mt-4 font-be-vietnam-pro text-base font-semibold uppercase tracking-[-0.02em] text-grey transition-colors duration-150 ease-out hover:text-ssa-red focus-visible:outline-none focus-visible:text-ssa-red"
              >
                View More
              </button>
            )}
